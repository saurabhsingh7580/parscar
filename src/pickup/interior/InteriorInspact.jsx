...
const InteriorInspact = props => {
  ...
  const setOject = async object => {
    try {
      ...
      await AsyncStorage.setItem('InteriorInspact' + OrderId, seri),
        console.log('Interior inspact object store,successfully...');
    } catch (error) {
  ...
  const getObject = async id => {
    try {
      ...
      if (seri !== null) {
        ...
        console.log('Retrived inspact kxnvkv object dk', parsedData);
        setState(prevState => ({
          ...prevState,
          UpdatedModalstatus: {
            ...prevState.UpdatedModalstatus,
  ...
  useEffect(() => {
    if (
      state.UpdatedModalstatus.FobsCombined &&
      state.UpdatedModalstatus.KeyFobs &&
      state.UpdatedModalstatus.Odor &&
      state.UpdatedModalstatus.Pet &&
      state.UpdatedModalstatus.Smoke &&
      state.UpdatedModalstatus.Telematics &&
      state.UpdatedModalstatus.Toll &&
      state.UpdatedModalstatus.Windshield
    ) {
      setState(prevState => ({
        ...prevState,
        Status: true
      ...
      <TouchableOpacity
        ...
        <View style={styles.listInner}>
          <Text style={styles.heading}>
            {extraValues ? extraValues : status}
          </Text>
          {/* {imageUrl === null ?
                      <>
                          {extraValues !== 'Ok' ?
  ...
  console.log(state.UpdatedModalstatus)
  return (
    <SafeAreaView style={styles.container}>
      <PDHeader
        HeaderName={'Interior Instapct'}
        OrderId={''}
        Screen={'PickupReport'}
      ...
      <ScrollView>
        ...
        <View style={styles.containerInner}>
          <View style={styles.body}>
            <Text style={styles.heading}>Surfaces</Text>
